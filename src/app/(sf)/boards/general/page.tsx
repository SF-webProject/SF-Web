      ...
      <div className={styles.boardWrap}>
        <div className={styles.toolbar}>
          <div className={styles.toolbarLeft}>
            ...
            <select className={styles.select} value={category} onChange={(e) => setCategory(e.target.value as any)} aria-label="카테고리 필터">
              <option value="all">전체 카테고리</option>
              <option value="기술 글">기술 글</option>
              <option value="질문 글">질문 글</option>
            </select>

            <select className={styles.select} value={sort} onChange={(e) => setSort(e.target.value as any)} aria-label="정렬">
