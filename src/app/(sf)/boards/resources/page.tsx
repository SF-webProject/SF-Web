            ...
            <div className={styles.boardWrap}>
                <div className={styles.toolbar}>
                    <div className={styles.toolbarLeft}>
                        ...
                        <select className={styles.select} value={type} onChange={(e) => setType(e.target.value as "all" | ResourceType)} aria-label="자료 유형 필터">
